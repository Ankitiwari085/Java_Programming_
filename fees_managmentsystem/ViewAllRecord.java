...
public void setRecordToTable(){
    ...
    private void initComponents() {
        ...
        jScrollPane1.setForeground(new java.awt.Color(8, 21, 51));

        tbl_allRecords.setBackground(new java.awt.Color(0, 153, 153));
        tbl_allRecords.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        tbl_allRecords.setForeground(new java.awt.Color(255, 255, 255));
        tbl_allRecords.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Receipt No.", "Student Name", "Roll No.", "Course ", "Date", "Payment Mode", "Total Amount", "Remarks"
            }
        ));
        jScrollPane1.setViewportView(tbl_allRecords);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 140, 930, 590));

        jLabel1.setFont(new java.awt.Font("Times New Roman", 1, 65)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(6, 23, 46));
        jLabel1.setText("All Records ");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 0, 350, 70));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 0, 960, 750));
        ...
        btnViewRecord.setText("View Report");
        ...
        getContentPane().add(panelSidebar, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 260, 750));
