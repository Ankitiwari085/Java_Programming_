...
public class AddFees extends javax.swing.JFrame {
    ...
    public boolean validation(){
        ...
        if(txt_ReceivedForm.getText().equals("")){
    ...
    public String insertData(){
        ...
        String studentName=txt_ReceivedForm.getText();
        ...
        int year2 =Integer.parseInt(txt_Year2.getText());
         ...
         try{
            Connection con =DBConnection.getConnection();
             ...
             pst.setDouble(10, totalAmount);
             pst.setString(11,date);
             pst.setDouble(12, initialAmount);
             pst.setDouble(13, cgst);
             pst.setDouble(14, sgst);
    ...
    private void initComponents() {
        ...
        txt_ReceivedForm = new javax.swing.JTextField();
        ...
        txt_ReceivedForm.setBackground(new java.awt.Color(0, 204, 204));
        txt_ReceivedForm.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        txt_ReceivedForm.setForeground(new java.awt.Color(255, 255, 255));
        panel_child.add(txt_ReceivedForm, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 20, 260, 30));
    ...
    private javax.swing.JTextField txt_ReceivedForm;
